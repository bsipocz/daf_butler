...
class Progress:
    ...
    _active_handler: ClassVar[ContextVar[Optional[ProgressHandler]]] = ContextVar("active_progress_handler",
                                                                                  default=None)
    ...
    def set_handler(cls, handler: Optional[ProgressHandler]) -> None:
        ...
        """
        cls._active_handler.set(handler)
    ...
    def is_enabled(self) -> bool:
        ...
        """
        if self._active_handler.get() is not None:
    ...
    def bar(
        ...
        total : `int`, optional
            ...
            progress bar works at all is handled-defined, and hence this mode
        ...
        if self.is_enabled():
            if desc is None:
                desc = self._name
            handler = self._active_handler.get()
...
class ProgressHandler(ABC):
    ...
    def get_progress_bar(self, iterable: Optional[Iterable[_T]], desc: str,
        ...
        total : `int` or `None`
            ...
            the progress bar works at all is handled-defined.
        level : `int`
